...
//
        ...
        Student random3 = new Student(23051814, "Ankan Chatterjee", 8.2f);
...
class Student {
    ...
    // we need one word to access every object. It basically means what object are we referring to in that particular
    // thing
